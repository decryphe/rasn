...
## [0.21.0](https://github.com/decryphe/rasn/compare/rasn-v0.20.2...rasn-v0.21.0) - 2024-10-30

### Fixed

- cleanup some unnecessary dependencies ([#362](https://github.com/decryphe/rasn/pull/362))
- remove version pin from release-plz ([#356](https://github.com/decryphe/rasn/pull/356))
- Don't override generics impl in proc-macros on encode impl ([#354](https://github.com/decryphe/rasn/pull/354))
- pin release-plz version until fixed ([#353](https://github.com/decryphe/rasn/pull/353))
- decoding of extended fields in sequence in BER ([#351](https://github.com/decryphe/rasn/pull/351))
- Fix most issues related to dependency update, except hashbrown version ([#349](https://github.com/decryphe/rasn/pull/349))

### Other

- Update base_benchmarks.yml
- Attempt to fix base benchmarks on CI ([#365](https://github.com/decryphe/rasn/pull/365))
- Update base_benchmarks.yml
- Update base_benchmarks.yml
- Create base_benchmarks.yml
- Update from iai to iai-callgrind ([#358](https://github.com/decryphe/rasn/pull/358))
- black box integer test, use macros ([#360](https://github.com/decryphe/rasn/pull/360))
- Optimize field presence tracking of default/optional/extended fields ([#324](https://github.com/decryphe/rasn/pull/324))
- run x509 benches only on x86_64 or aarch64 ([#355](https://github.com/decryphe/rasn/pull/355))
