...
## [0.22.1](https://github.com/decryphe/rasn/compare/rasn-v0.22.0...rasn-v0.22.1) - 2024-12-05

### Fixed

- FixedBitString might work as expected ([#385](https://github.com/decryphe/rasn/pull/385))

### Other

- oer: format! in error messages has too much impact ([#387](https://github.com/decryphe/rasn/pull/387))
- Add `decode_with_remainder` for decoding stream ([#386](https://github.com/decryphe/rasn/pull/386))
- OER: remove nom usage, improve errors ([#384](https://github.com/decryphe/rasn/pull/384))
- Remove trails of BitSlice and unnecessary length checks ([#381](https://github.com/decryphe/rasn/pull/381))
- use shifting to construct primitive integers ([#379](https://github.com/decryphe/rasn/pull/379))
